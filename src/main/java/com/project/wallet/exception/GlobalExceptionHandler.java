...
//    public ResponseEntity<WalletResponseDto> handleGeneralError(Exception ex) {
//        WalletResponseDto response = new WalletResponseDto(null, null, "Internal server error");
